...
def wor_press(window, fulwidth, fulheight, workers_list):
    ...
    wor_tree.heading("Name", text="Имя", anchor='center', command= lambda: utils.sort_people_list_by_column(wor_tree, workers_list, "Name", False))
    wor_tree.heading("Gender", text="Пол", anchor='center', command= lambda: utils.sort_people_list_by_column(wor_tree, workers_list, "Gender", False))
    wor_tree.heading("Date of Birth", text="Дата рождения", anchor='center', command= lambda: utils.sort_people_list_by_column(wor_tree, workers_list, "Date of Birth", False))
    ...
    # Worker Control
    Label(wor_subwin, bg='deep sky blue', fg='white', text='Управление работниками', font=("Ariel", 20, 'bold')).place(x=50, y=25, width=fulwidth/2-100, height=50)
    ...
    Label(wor_subwin, text='  - Записи, отмеченные "*", не должны быть пустыми. ', anchor='w', bg='deep sky blue', fg='white', font=("Ariel", 12, 'bold')).place(x=50, y=360, height=30)
    Label(wor_subwin, text='  - Идентификатор должен быть "D-xxx ', anchor='w', bg='deep sky blue', fg='white', font=("Ariel", 12, 'bold')).place(x=50, y=385, height=30)
    Label(wor_subwin, text='  - Пол должен быть " M " or " F " ', anchor='w', bg='deep sky blue', fg='white', font=("Ariel", 12, 'bold')).place(x=50, y=410, height=30)
    Label(wor_subwin, text='  - Дата рождения должна быть «дд/мм/гггг». " ', anchor='w', bg='deep sky blue', fg='white', font=("Ariel", 12, 'bold')).place(x=50, y=435, height=30)
    Label(wor_subwin, text='  - Телефон и зарплата должны быть цифрами', anchor='w', bg='deep sky blue', fg='white', font=("Ariel", 12, 'bold')).place(x=50, y=460, height=30)
    ...
    # Buttons
    add_worker_button = Button(wor_subwin, text='Добавить работника',anchor='center',font=("Ariel", 12,'bold'), fg='deep sky blue', relief='ridge',
    ...
    update_worker_button = Button(wor_subwin, text='Обновить',anchor='center',font=("Ariel", 12,'bold'), fg='deep sky blue', relief='ridge',
    ...
    clear_button = Button(wor_subwin, text='Очистить',anchor='center',font=("Ariel", 12,'bold'), fg='red', relief='ridge',
    ...
    remove_worker_button = Button(wor_subwin, text='Убрать выбраное',anchor='center',font=("Ariel", 12,'bold'),bg='red', fg='white', relief='ridge',
    ...
    remove_all_worker_button = Button(wor_subwin, text='Убрать все',anchor='center',font=("Ariel", 12,'bold'),bg='red', fg='white', relief='ridge',
    ...
    select_worker_button = Button(wor_subwin, text='Выбрать',anchor='center',font=("Ariel", 12,'bold'), bg='deep sky blue',fg='white', relief='ridge',
