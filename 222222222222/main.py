...
#Set title
window.title("Система управления больничной информацией")
...
# Right Panel
Label(window, text="ИНФОРМАЦИЯ О БОЛЬНИЦЕ",bg="deep sky blue", fg="white", font=("Ariel", 25,'bold')).place(x = fulwidth/2, y = fulheight-250, width=fulwidth/2, height=25)
Label(window, text="СИСТЕМА УПРАВЛЕНИЯ",bg="deep sky blue", fg="white", font=("Ariel", 25,'bold')).place(x = fulwidth/2, y = fulheight-200, width=fulwidth/2, height=25)
...
# Buttons
doctors_button = Button(window, text="Доктора", anchor='center', font=("Ariel", 20,'bold'), bg="deep sky blue", fg="white", relief='ridge',
...
workers_button = Button(window, text="Работники", anchor='center', font=("Ariel", 20,'bold'), bg="deep sky blue", fg="white", relief='ridge',
...
patients_button = Button(window, text="Пациенты", anchor='center', font=("Ariel", 20,'bold'), bg="deep sky blue", fg="white", relief='ridge',
...
medicines_button = Button(window, text="Лекарства", anchor='center', font=("Ariel", 20,'bold'), bg="deep sky blue", fg="white", relief='ridge',
