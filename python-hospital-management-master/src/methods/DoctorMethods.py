...
def patients_assignment(doc_subwin, doc_tree, fulwidth, fulheight, pa_doc_list, patients_list, assigned_patients_list, unassigned_patients_list):
    if selected_doctor != -1:    
        ...
        Label(docpa_subwin, text='ASSIGNED PATIENTS', bg='#88C1C2', fg='white', font=("Work Sans", 20, 'bold')).place(x=50,y=50,width=fulwidth/2-100,height=50)
        Label(docpa_subwin, text='UNASSIGNED PATIENTS', fg='#88C1C2', font=("Work Sans", 20, 'bold')).place(x=fulwidth/2+50,y=50,width=fulwidth/2-100,height=50)
        ...
        # ===============================================================================
        # Count
        Label(docpa_subwin, text=f"COUNT: {assigned_patients_count}", anchor='e', bg='#88C1C2', fg='white', font=("Work Sans", 16, 'bold')).place(x=fulwidth/4+50,y=fulheight-150,width=200,height=50)
        ...
        # ===============================================================================
        # Buttons
        assign_patient_button = Button(docpa_subwin, text='ASSIGN PATIENT', font=("Work Sans", 16, 'bold'), fg='white', bg='#88C1C2', relief='ridge',
            activebackground='#88C1C2', activeforeground='white', command=lambda: assign_patient(docpa_subwin, fulwidth, fulheight, unassigned_patients_tree, assigned_patients_tree, unassigned_patients_list, assigned_patients_list, patients_list, doctor_id, pa_doc_list))
        assign_patient_button.place(x=fulwidth/2+50, y=fulheight-150, width=250, height=50)

        unassign_patient_button = Button(docpa_subwin, text='UNASSIGN PATIENT', font=("Work Sans", 16, 'bold'), fg='#88C1C2', relief='ridge',
            activebackground='#88C1C2', activeforeground='white', command=lambda: unassign_patient(docpa_subwin, fulwidth, fulheight, unassigned_patients_tree, assigned_patients_tree, unassigned_patients_list, assigned_patients_list, patients_list, doctor_id, pa_doc_list))
...
def doc_press(window, fulwidth, fulheight, doctors_list, patients_list, pa_doc_list):
    ...
    # Doctor Control
    Label(doc_subwin, bg='#88C1C2', fg='white', text='DOCTORS MANAGEMENT', font=("Work Sans", 20, 'bold')).place(x=50, y=25, width=fulwidth/2-100, height=50)
    Frame(doc_subwin, bg='crimson').place(x=50, y=85, width=fulwidth/2-100, height=2)
    entry_frame = Frame(doc_subwin, bg='#88C1C2')
    ...
    Label(doc_subwin, text='  - Entries marked with " * " must not be empty ', anchor='w', bg='#88C1C2', fg='white', font=("Work Sans", 12, 'bold')).place(x=50, y=360, height=30)
    Label(doc_subwin, text='  - ID must be " D-xxx " ', anchor='w', bg='#88C1C2', fg='white', font=("Work Sans", 12, 'bold')).place(x=50, y=385, height=30)
    Label(doc_subwin, text='  - Gender must be " M " or " F " ', anchor='w', bg='#88C1C2', fg='white', font=("Work Sans", 12, 'bold')).place(x=50, y=410, height=30)
    Label(doc_subwin, text='  - Date of Birth must be " dd/mm/yyyy " ', anchor='w', bg='#88C1C2', fg='white', font=("Work Sans", 12, 'bold')).place(x=50, y=435, height=30)
    Label(doc_subwin, text='  - Phone & Salary must be numbers ', anchor='w', bg='#88C1C2', fg='white', font=("Work Sans", 12, 'bold')).place(x=50, y=460, height=30)
    ...
    # Buttons
    add_doctor_button = Button(doc_subwin, text='ADD DOCTOR',anchor='center',font=("Work Sans", 12,'bold'), fg='#88C1C2', relief='ridge',
        activebackground='#88C1C2', activeforeground='white', command=lambda: doc_add(doctors_list, doc_tree, entry_frame, id_entry, name_entry, gend_entry, dob_entry,phone_entry,email_entry,dept_entry,salary_entry))
    add_doctor_button.place(x=50, y=fulheight-75-85-10-50, width=150, height=50)
    changeColor(add_doctor_button, "#c5ede2", "white")
    
    update_doctor_button = Button(doc_subwin, text='UPDATE',anchor='center',font=("Work Sans", 12,'bold'), fg='#88C1C2', relief='ridge',
        activebackground='#88C1C2', activeforeground='white', command=lambda: doc_update(doctors_list, pa_doc_list, doc_tree, entry_frame, id_entry, name_entry, gend_entry, dob_entry, phone_entry, email_entry, dept_entry, salary_entry))
    update_doctor_button.place(x=fulwidth/2-50-150, y=fulheight-75-85-10-50, width=150, height=50)
    changeColor(update_doctor_button, "#c5ede2", "white")
    
    clear_button = Button(doc_subwin, text='CLEAR',anchor='center',font=("Work Sans", 12,'bold'), fg='red', relief='ridge',
    ...
    remove_doctor_button = Button(doc_subwin, text='REMOVE SELECTED',anchor='center',font=("Work Sans", 12,'bold'),bg='white', fg='red', relief='ridge',
    ...
    changeColor(remove_doctor_button, "#f2dada", "white")
    
    remove_all_doctor_button = Button(doc_subwin, text='REMOVE ALL',anchor='center',font=("Work Sans", 12,'bold'),bg='white', fg='red', relief='ridge',
    ...
    changeColor(remove_all_doctor_button, "#f2dada", "white")
    
    select_doctor_button = Button(doc_subwin, text='SELECT',anchor='center',font=("Work Sans", 12,'bold'), bg='white',fg='#88C1C2', relief='ridge',
        activebackground='#88C1C2', activeforeground='white', command=lambda: doc_select(doctors_list, doc_tree, entry_frame, id_entry, name_entry, gend_entry, dob_entry,phone_entry,email_entry,dept_entry,salary_entry))
    select_doctor_button.place(x=fulwidth/2+50, y=fulheight-75-85, width=150, height=50)
    changeColor(select_doctor_button, "#c5ede2", "white")
    
    patients_assignment_button = Button(doc_subwin, text='PATIENTS ASSIGNMENT',anchor='center',font=("Work Sans", 12,'bold'), fg='#88C1C2', relief='ridge',
        activebackground='#88C1C2', activeforeground='white', command=lambda: patients_assignment(doc_subwin, doc_tree, fulwidth, fulheight, pa_doc_list, patients_list, assigned_patients_list, unassigned_patients_list))
