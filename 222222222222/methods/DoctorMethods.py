...
def patients_assignment(doc_subwin, doc_tree, fulwidth, fulheight, pa_doc_list, patients_list, assigned_patients_list, unassigned_patients_list):
    if selected_doctor != -1:    
        ...
        Label(docpa_subwin, text='Назначенные пациенты', bg='deep sky blue', fg='white', font=("Ariel", 20, 'bold')).place(x=50,y=50,width=fulwidth/2-100,height=50)
        Label(docpa_subwin, text='Неназначенные пациенты', fg='deep sky blue', font=("Ariel", 20, 'bold')).place(x=fulwidth/2+50,y=50,width=fulwidth/2-100,height=50)
        ...
        unassigned_patients_tree.heading("Name", text="Имя", anchor='center', command= lambda: utils.sort_people_list_by_column(unassigned_patients_tree, unassigned_patients_list, "Name", False))
        unassigned_patients_tree.heading("Gender", text="Пол", anchor='center', command= lambda: utils.sort_people_list_by_column(unassigned_patients_tree, unassigned_patients_list, "Gender", False))
        unassigned_patients_tree.heading("Date of Birth", text="Дата рождения", anchor='center', command= lambda: utils.sort_people_list_by_column(unassigned_patients_tree, unassigned_patients_list, "Date of Birth", False))
        ...
        assigned_patients_tree.heading("Name", text="Имя", anchor='center', command= lambda: utils.sort_people_list_by_column(assigned_patients_tree, assigned_patients_list, "Name", False))
        assigned_patients_tree.heading("Gender", text="Пол", anchor='center', command= lambda: utils.sort_people_list_by_column(assigned_patients_tree, assigned_patients_list, "Gender", False))
        assigned_patients_tree.heading("Date of Birth", text="Дата рождения", anchor='center', command= lambda: utils.sort_people_list_by_column(assigned_patients_tree, assigned_patients_list, "Date of Birth", False))
        ...
        # ===============================================================================
        # Buttons
        assign_patient_button = Button(docpa_subwin, text='Назначенные пациенты', font=("Ariel", 16, 'bold'), fg='white', bg='deep sky blue', relief='ridge',
        ...
        unassign_patient_button = Button(docpa_subwin, text='Не назначенные пациенты', font=("Ariel", 16, 'bold'), fg='deep sky blue', relief='ridge',
...
def assign_patient(docpa_subwin, fulwidth, fulheight, unassigned_patients_tree, assigned_patients_tree, unassigned_patients_list, assigned_patients_list, patients_list, doctor_id, pa_doc_list):
    if len(unassigned_patients_tree.selection())>0:
        ...
        # ===============================================================================
        # Count
        Label(docpa_subwin, text=f"Колличество: {assigned_patients_count}", anchor='e', bg='deep sky blue', fg='black', font=("Ariel", 16, 'bold')).place(x=fulwidth/4+50,y=fulheight-150,width=200,height=50)
        Label(docpa_subwin, text=f"Колличество: {unassigned_patients_count}", anchor='e',fg='black', font=("Ariel", 16, 'bold')).place(x=fulwidth/4*3+50,y=fulheight-150,width=200,height=50)
...
def doc_press(window, fulwidth, fulheight, doctors_list, patients_list, pa_doc_list):
    ...
    doc_tree.heading("Name", text="Имя", anchor='center', command= lambda: utils.sort_people_list_by_column(doc_tree, doctors_list, "Name", False))
    doc_tree.heading("Gender", text="Пол", anchor='center', command= lambda: utils.sort_people_list_by_column(doc_tree, doctors_list, "Gender", False))
    doc_tree.heading("Date of Birth", text="Дата рождения", anchor='center', command= lambda: utils.sort_people_list_by_column(doc_tree, doctors_list, "Date of Birth", False))
    ...
    # Doctor Control
    Label(doc_subwin, bg='deep sky blue', fg='white', text='Управление врачами', font=("Ariel", 20, 'bold')).place(x=50, y=25, width=fulwidth/2-100, height=50)
    ...
    Label(doc_subwin, text='  - Записи, отмеченные "*", не должны быть пустыми. ', anchor='w', bg='deep sky blue', fg='white', font=("Ariel", 12, 'bold')).place(x=50, y=360, height=30)
    Label(doc_subwin, text='  - Идентификатор должен быть "D-xxx ', anchor='w', bg='deep sky blue', fg='white', font=("Ariel", 12, 'bold')).place(x=50, y=385, height=30)
    Label(doc_subwin, text='  - Пол должен быть " M " or " F " ', anchor='w', bg='deep sky blue', fg='white', font=("Ariel", 12, 'bold')).place(x=50, y=410, height=30)
    Label(doc_subwin, text='  - Дата рождения должна быть «дд/мм/гггг». " ', anchor='w', bg='deep sky blue', fg='white', font=("Ariel", 12, 'bold')).place(x=50, y=435, height=30)
    Label(doc_subwin, text='  - Телефон и зарплата должны быть цифрами', anchor='w', bg='deep sky blue', fg='white', font=("Ariel", 12, 'bold')).place(x=50, y=460, height=30)
    ...
    Label(entry_frame, bg='deep sky blue', fg='white', text=' - Отдел - ', font=("Ariel", 14, 'bold')).grid(column=2, row=6)
    Label(entry_frame, bg='deep sky blue', fg='white', text=' - Зарплата - ', font=("Ariel", 14, 'bold')).grid(column=2, row=7)
    ...
    # Buttons
    add_doctor_button = Button(doc_subwin, text='Добавить врача',anchor='center',font=("Ariel", 12,'bold'), fg='deep sky blue', relief='ridge',
    ...
    update_doctor_button = Button(doc_subwin, text='Обновить',anchor='center',font=("Ariel", 12,'bold'), fg='deep sky blue', relief='ridge',
    ...
    clear_button = Button(doc_subwin, text='Очистить',anchor='center',font=("Ariel", 12,'bold'), fg='red', relief='ridge',
    ...
    remove_doctor_button = Button(doc_subwin, text='Убрать выбраное',anchor='center',font=("Ariel", 12,'bold'),bg='red', fg='white', relief='ridge',
    ...
    remove_all_doctor_button = Button(doc_subwin, text='Убрать все',anchor='center',font=("Ariel", 12,'bold'),bg='red', fg='white', relief='ridge',
    ...
    select_doctor_button = Button(doc_subwin, text='Выбрать',anchor='center',font=("Ariel", 12,'bold'), bg='deep sky blue',fg='white', relief='ridge',
    ...
    patients_assignment_button = Button(doc_subwin, text='Распределение пациентов',anchor='center',font=("Ariel", 12,'bold'), fg='deep sky blue', relief='ridge',
