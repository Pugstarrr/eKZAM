...
def doctors_assignment(pat_subwin, pat_tree, fulwidth, fulheight, pa_doc_list, doctors_list, assigned_doctors_list, unassigned_doctors_list):
    if selected_patient != -1:    
        ...
        Label(patda_subwin, text='Назначенные врачи', bg='deep sky blue', fg='white', font=("Ariel", 20, 'bold')).place(x=50,y=50,width=fulwidth/2-100,height=50)
        Label(patda_subwin, text='Не назначенные врачи', fg='deep sky blue', font=("Ariel", 20, 'bold')).place(x=fulwidth/2+50,y=50,width=fulwidth/2-100,height=50)
        ...
        unassigned_doctors_tree.heading("Name", text="Имя", anchor='center', command= lambda: utils.sort_people_list_by_column(unassigned_doctors_tree, unassigned_doctors_list, "Name", False))
        unassigned_doctors_tree.heading("Gender", text="Пол", anchor='center', command= lambda: utils.sort_people_list_by_column(unassigned_doctors_tree, unassigned_doctors_list, "Gender", False))
        unassigned_doctors_tree.heading("Date of Birth", text="Дата рождения", anchor='center', command= lambda: utils.sort_people_list_by_column(unassigned_doctors_tree, unassigned_doctors_list, "Date of Birth", False))
        ...
        assigned_doctors_tree.heading("Name", text="Имя", anchor='center', command= lambda: utils.sort_people_list_by_column(assigned_doctors_tree, assigned_doctors_list, "Name", False))
        assigned_doctors_tree.heading("Gender", text="Пол", anchor='center', command= lambda: utils.sort_people_list_by_column(assigned_doctors_tree, assigned_doctors_list, "Gender", False))
        assigned_doctors_tree.heading("Date of Birth", text="Дата рождения", anchor='center', command= lambda: utils.sort_people_list_by_column(assigned_doctors_tree, assigned_doctors_list, "Date of Birth", False))
        ...
        # Buttons
        assign_doctor_button = Button(patda_subwin, text='Назначенные врачи', font=("Ariel", 16, 'bold'), fg='white', bg='deep sky blue', relief='ridge',
        ...
        unassign_doctor_button = Button(patda_subwin, text='Не назначенные врачи', font=("Ariel", 16, 'bold'), fg='deep sky blue', relief='ridge',
...
def medicines_asignment(pat_subwin, pat_tree, fulwidth, fulheight, pa_med_list, medicines_list, assigned_medicines_list, unassigned_medicines_list):
    if selected_patient != -1:    
        ...
        Label(patma_subwin, text='Назначенные врачи', bg='deep sky blue', fg='white', font=("Ariel", 20, 'bold')).place(x=50,y=50,width=fulwidth/2-100,height=50)
        Label(patma_subwin, text='Не назначенные врачи', fg='deep sky blue', font=("Ariel", 20, 'bold')).place(x=fulwidth/2+50,y=50,width=fulwidth/2-100,height=50)
        ...
        unassigned_medicines_tree.heading("Name", text="Имя", anchor='center', command= lambda: utils.sort_medicines_list_by_column(unassigned_medicines_tree, unassigned_medicines_list, "Name", False))
        unassigned_medicines_tree.heading("Price", text="Цена", anchor='center', command= lambda: utils.sort_medicines_list_by_column(unassigned_medicines_tree, unassigned_medicines_list, "Price", False))
        unassigned_medicines_tree.heading("Stock", text="Запас", anchor='center', command= lambda: utils.sort_medicines_list_by_column(unassigned_medicines_tree, unassigned_medicines_list, "Stock", False))
        ...
        assigned_medicines_tree.heading("Name", text="Имя", anchor='center', command= lambda: utils.sort_medicines_list_by_column(assigned_medicines_tree, assigned_medicines_list, "Name", False))
        assigned_medicines_tree.heading("Price", text="Цена", anchor='center', command= lambda: utils.sort_medicines_list_by_column(assigned_medicines_tree, assigned_medicines_list, "Price", False))
        assigned_medicines_tree.heading("Stock", text="Запас", anchor='center', command= lambda: utils.sort_medicines_list_by_column(assigned_medicines_tree, assigned_medicines_list, "Stock", False))
        ...
        # Buttons
        assign_medicine_button = Button(patma_subwin, text='Назначенные лекарства', font=("Ariel", 16, 'bold'), fg='white', bg='deep sky blue', relief='ridge',
        ...
        unassign_medicine_button = Button(patma_subwin, text='Не назначенные лекарства', font=("Ariel", 16, 'bold'), fg='deep sky blue', relief='ridge',
...
def pat_press(window, fulwidth, fulheight, doctors_list, patients_list, medicines_list, pa_doc_list, pa_med_list):
    ...
    pat_tree.heading("Name", text="Имя", anchor='center', command= lambda: utils.sort_people_list_by_column(pat_tree, patients_list, "Name", False))
    pat_tree.heading("Gender", text="Пол", anchor='center', command= lambda: utils.sort_people_list_by_column(pat_tree, patients_list, "Gender", False))
    pat_tree.heading("Date of Birth", text="Дата рождения", anchor='center', command= lambda: utils.sort_people_list_by_column(pat_tree, patients_list, "Date of Birth", False))
    ...
    Label(pat_subwin, bg='deep sky blue', fg='white', text='Управление Пациентами', font=("Ariel", 20, 'bold')).place(x=50, y=25, width=fulwidth/2-100, height=50)
    ...
    Label(pat_subwin, text='  - Записи, отмеченные "*", не должны быть пустыми. ', anchor='w', bg='deep sky blue', fg='white', font=("Ariel", 12, 'bold')).place(x=50, y=360, height=30)
    Label(pat_subwin, text='  - Идентификатор должен быть "D-xxx ', anchor='w', bg='deep sky blue', fg='white', font=("Ariel", 12, 'bold')).place(x=50, y=385, height=30)
    Label(pat_subwin, text='  - Пол должен быть " M " or " F " ', anchor='w', bg='deep sky blue', fg='white', font=("Ariel", 12, 'bold')).place(x=50, y=410, height=30)
    Label(pat_subwin, text='  - Дата рождения должна быть «дд/мм/гггг». " ', anchor='w', bg='deep sky blue', fg='white', font=("Ariel", 12, 'bold')).place(x=50, y=435, height=30)
    Label(pat_subwin, text='  - Телефон и зарплата должны быть цифрами', anchor='w', bg='deep sky blue', fg='white', font=("Ariel", 12, 'bold')).place(x=50, y=460, height=30)
    ...
    Label(entry_frame, bg='deep sky blue', fg='white', text=' - Имя - ', font=("Ariel", 14, 'bold')).grid(column=2, row=1)
    Label(entry_frame, bg='deep sky blue', fg='white', text=' - Пол - ', font=("Ariel", 14, 'bold')).grid(column=2, row=2)
    Label(entry_frame, bg='deep sky blue', fg='white', text=' - ДР - ', font=("Ariel", 14, 'bold')).grid(column=2, row=3)
    Label(entry_frame, bg='deep sky blue', fg='white', text=' - Телефон - ', font=("Ariel", 14, 'bold')).grid(column=2, row=4)
    Label(entry_frame, bg='deep sky blue', fg='white', text=' - Почта - ', font=("Ariel", 14, 'bold')).grid(column=2, row=5)
    Label(entry_frame, bg='deep sky blue', fg='white', text=' - Болезнь - ', font=("Ariel", 14, 'bold')).grid(column=2, row=6)
    Label(entry_frame, bg='deep sky blue', fg='white', text=' - Долг - ', font=("Ariel", 14, 'bold')).grid(column=2, row=7)
    ...
    # Buttons
    add_patient_button = Button(pat_subwin, text='Добавить пациента',anchor='center',font=("Ariel", 12,'bold'), fg='deep sky blue', relief='ridge',
    ...
    update_patient_button = Button(pat_subwin, text='Обновить',anchor='center',font=("Ariel", 12,'bold'), fg='deep sky blue', relief='ridge',
    ...
    clear_button = Button(pat_subwin, text='Очитстить',anchor='center',font=("Ariel", 12,'bold'), fg='red', relief='ridge',
    ...
    remove_patient_button = Button(pat_subwin, text='Убрать выбраное',anchor='center',font=("Ariel", 12,'bold'),bg='red', fg='white', relief='ridge',
    ...
    remove_all_patient_button = Button(pat_subwin, text='Убрать все',anchor='center',font=("Ariel", 12,'bold'),bg='red', fg='white', relief='ridge',
    ...
    select_patient_button = Button(pat_subwin, text='Выбрать',anchor='center',font=("Ariel", 12,'bold'), bg='deep sky blue',fg='white', relief='ridge',
    ...
    doctors_assignment_button = Button(pat_subwin, text='Назначение врачей',anchor='center',font=("Ariel", 12,'bold'), bg='white',fg='deep sky blue', relief='ridge',
    ...
    medicines_assignment_button = Button(pat_subwin, text='Назначение Лекарств',anchor='center',font=("Ariel", 12,'bold'), bg='white',fg='deep sky blue', relief='ridge',
