...
def patients_assignment(med_subwin, med_tree, fulwidth, fulheight, pa_med_list, patients_list, assigned_patients_list, unassigned_patients_list):
    if selected_medicine != -1:    
        ...
        Label(medpa_subwin, text='Назначенные пациенты', bg='deep sky blue', fg='white', font=("Ariel", 20, 'bold')).place(x=50,y=50,width=fulwidth/2-100,height=50)
        Label(medpa_subwin, text='Не назначенные пациенты', fg='deep sky blue', font=("Ariel", 20, 'bold')).place(x=fulwidth/2+50,y=50,width=fulwidth/2-100,height=50)
        ...
        # Buttons
        assign_patient_button = Button(medpa_subwin, text='Назначенные пациенты', font=("Ariel", 16, 'bold'), fg='white', bg='deep sky blue', relief='ridge',
        ...
        unassign_patient_button = Button(medpa_subwin, text='Не назначенные пациенты', font=("Ariel", 16, 'bold'), fg='deep sky blue', relief='ridge',
...
def med_press(window, fulwidth, fulheight, medicines_list, patients_list, pa_med_list):
    ...
    med_tree.heading("Name", text="Имя", anchor='center', command= lambda: utils.sort_medicines_list_by_column(med_tree, medicines_list, "Name", False))
    med_tree.heading("Price", text="Цена", anchor='center', command= lambda: utils.sort_medicines_list_by_column(med_tree, medicines_list, "Price", False))
    med_tree.heading("Stock", text="Запас", anchor='center', command= lambda: utils.sort_medicines_list_by_column(med_tree, medicines_list, "Stock", False))
    ...
    #=====================================================================================
    Label(med_subwin, bg='deep sky blue', fg='white', text='Управление лекарствами', font=("Ariel", 20, 'bold')).place(x=50, y=25, width=fulwidth/2-100, height=50)
    ...
    Label(entry_frame, bg='deep sky blue', fg='white', text=' - Цена - ', font=("Ariel", 14, 'bold')).grid(column=2, row=2)
    Label(entry_frame, bg='deep sky blue', fg='white', text=' - Запас - ', font=("Ariel", 14, 'bold')).grid(column=2, row=3)
    ...
    # Description
    Label(text_frame, bg='deep sky blue', fg='white', text='  ', font=("Ariel", 14, 'bold')).grid(column=0, row=0)
    description_entry = Text(text_frame, width=65, height=5)
    description_entry.grid(row=1, column=0, columnspan=5)

    #==================================================================================

    Label(med_subwin, text='  - Записи, отмеченные "*", не должны быть пустыми ', anchor='w', bg='deep sky blue', fg='white', font=("Ariel", 12, 'bold')).place(x=50, y=360, height=30)
    Label(med_subwin, text='  - Идентификатор должен быть "D-xxx " ', anchor='w', bg='deep sky blue', fg='white', font=("Ariel", 12, 'bold')).place(x=50, y=385, height=30)


    add_medicine_button = Button(med_subwin, text='Добавить лекарства',anchor='center',font=("Ariel", 12,'bold'), fg='deep sky blue', relief='ridge',
    ...
    update_medicine_button = Button(med_subwin, text='Обновить',anchor='center',font=("Ariel", 12,'bold'), fg='deep sky blue', relief='ridge',
    ...
    clear_button = Button(med_subwin, text='Очистить',anchor='center',font=("Ariel", 12,'bold'), fg='red', relief='ridge',
    ...
    remove_medicine_button = Button(med_subwin, text='Убрать выбранное',anchor='center',font=("Ariel", 12,'bold'),bg='red', fg='white', relief='ridge',
    ...
    remove_all_medicine_button = Button(med_subwin, text='Убрать все',anchor='center',font=("Ariel", 12,'bold'),bg='red', fg='white', relief='ridge',
    ...
    select_medicine_button = Button(med_subwin, text='Выбрать',anchor='center',font=("Ariel", 12,'bold'), bg='deep sky blue',fg='white', relief='ridge',
    ...
    patients_assignment_button = Button(med_subwin, text='Распределение лекарств',anchor='center',font=("Ariel", 12,'bold'), fg='deep sky blue', relief='ridge',
